...
/**
 * This class implements an ArrayList-based Heap data structure
 *
...
public class Heap<T extends Comparable<T>> {
    ...
    /**
     * A helper method to determine the index of the left child of a heap
     * element
     *
    ...
    /**
     * A helper method to determine the index of the right child of a heap
     * element
     *
     * @param i The index of the heap element
...
// until it finds its proper place in the heap
    ...
    /**
     * This method removes an element from the root of the heap preserving the
     * heap property
     *
